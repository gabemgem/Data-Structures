...
int findPaths(int x, int y, const vector<vector<bool> >& blocked_grid, bool& print) {
  ...
  int ret = findPaths(x-1, y, blocked_grid, print); 
  if(ret==0)
    ret = findPaths(x, y-1, blocked_grid, print);
...
int main(int argc, char* argv[]) {
  ...
  bool print=true;
  cout<<"\nPaths: "<<findPaths(start_x, start_y, blocked_grid, print)<<endl;
