	...
	test_v.push_back(2);
	test_v.push_back(5);
	cout << "Contents of vector test_v: ";
	for ( Vec<double>::size_type j = 0; j < test_v.size(); j++ )
	cout << " " << test_v[j];
	cout << endl;
	
	cout<<"Number of 2's: "<<remove_matching_elements(test_v, 2)<<endl;
	
	cout << "Contents of vector after removing 2's: ";
	for ( Vec<double>::size_type j = 0; j < test_v.size(); j++ )
	cout << " " << test_v[j];
	cout << endl;

	cout<<"Number of 5's: "<<remove_matching_elements(test_v, 5)<<endl;
	
	cout << "Contents of vector after removing 5's: ";
	for ( Vec<double>::size_type j = 0; j < test_v.size(); j++ )
	cout << " " << test_v[j];
	cout << endl;
	...
	tester.print();
	remove_matching_elements(tester,1);
	tester.print();
	tester.push_back(5);
	tester.print();
	remove_matching_elements(tester,5);
	tester.print();
	for(int i=0; i<10; i++)
		tester.push_back(3);
	tester.print();
	remove_matching_elements(tester, 3);
	tester.print();
	
	Vec<string> stester;
	
	stester.push_back("hi");
	stester.push_back("Gabe");
	stester.push_back("I");
	stester.push_back("am");
	stester.push_back("Gabe");
	
	cout<<endl<<endl;
	stester.print();
	string s="Fish";
	remove_matching_elements(stester, s);
	stester.print();
	s="Gabe";
	remove_matching_elements(stester, s);
	stester.print();
